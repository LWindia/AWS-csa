            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600">100% practical sessions with real AWS environment access for all students</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Interview preparation, and job placement assistance</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Direct hiring partnerships with 100+ companies for job placements</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Comprehensive support to ensure your AWS certification success</p>
                </div>
              </div>
            </div>
          </div>
